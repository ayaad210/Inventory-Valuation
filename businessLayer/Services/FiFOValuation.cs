...
{
    public class FIFOValuation : IInvintoryValuationStrategy
    {
        ...
        public FIFOValuation(IUnitOfWork unitOfWork)
        ...
        public async Task<Evaluation> EvaluateInventory()
        {
            ...
            try
            {
                ...
                foreach (var item in items)
                {
                    ...
                    var ItemRequests = await requestRepo.Get(x => x.ItemId == item.Id, x => x.OrderBy(i => i.id));
